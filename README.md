...
| **go-e Controller** (nur lesend) | Spannungen L1/L2/L3/N, 6 Stromsensoren (Strom, Leistung), Kategorien Home/Netz/Fahrzeug/Relais/Solar/Batterie (Leistung + Energie In/Out) | Energiemess-Zentrale, keine Steuerung. Register gemäß offizieller Doku ([go-eController-API](https://github.com/goecharger/go-eController-API), modbus-de.md): FC 0x04, Float32/Float64 Big-Endian. Modbus muss ebenfalls erst per App/HTTP-API aktiviert werden. |

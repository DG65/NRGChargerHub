...
![Modul Version](https://img.shields.io/badge/Modul_Version-0.9.73--beta.1-blue)
...
| `manufacturer` | string | Interner Hersteller-Schlüssel (`goe`/`keba`/`alfen`/`heidelberg`/`abl`) |

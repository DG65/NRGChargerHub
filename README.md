...
| 🧪 **Peblar Home/Home Plus/Business** (auch ChargeLine) — **experimentell** | Ladestatus (CP A–F), Leistung, Energie gesamt, Leistung/Spannung/Strom je Phase, Seriennummer/Produkt/Firmware, „Begrenzt durch", Kabelsperre; Steuerung: Ladefreigabe (= Modbus-Stromlimit 0), Stromlimit, Einphasig erzwingen (nur mit unabhängigem Relais) | Binäres Modbus TCP, Unit-ID 255, Port 502, Firmware 1.6+, Modbus-Server im Web-Interface aktivieren, Smart-Charging auf „Standard". Messwerte Input-Register (FC 0x04) ab 30000, Steuerung Holding ab 40000. Registerkarte gegen Peblars offiziellen Beispielclient und evcc gegengelesen. **Noch nicht an echter Hardware bestätigt** — Hardware-Prüfung durch einen Forum-Tester geplant. |
